export const environment = {
  ...
  vouchSocials: {
    ...
    x:         { label: 'X',         url: 'https://x.com/vouch_placeholder' },
    instagram: { label: 'Instagram', url: 'https://instagram.com/vouch_placeholder' },
    discord:   { label: 'Discord',   url: 'https://discord.gg/vouch_placeholder' },
  },
};
